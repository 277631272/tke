...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter, policyGetter rest.Getter, platformClient platformversionedclient.PlatformV2Interface) *Storage {
