...
var map_ClusterFeature = map[string]string{
	...
	"featureGates":     "FeatureGates enabled by the user.",
}
...
var map_ClusterSpec = map[string]string{
	...
	"scheduler":            "Scheduler contains extra settings for the scheduler control plane component",
	"docker":               "DockerInfo holds settings necessary for Docker in the cluster",
	"kubelet":              "Kubelet holds settings necessary for Kubelet in the cluster",
}
...
var map_ControlPlaneComponent = map[string]string{
	"": "ControlPlaneComponent holds settings common to control plane component of the cluster",
}

func (ControlPlaneComponent) SwaggerDoc() map[string]string {
	return map_ControlPlaneComponent
}
...
var map_DockerInfo = map[string]string{
	"": "DockerInfo holds settings necessary for Docker in the cluster",
}

func (DockerInfo) SwaggerDoc() map[string]string {
	return map_DockerInfo
}
...
var map_Kubelet = map[string]string{
	"": "Kubelet holds settings necessary for Kubelet in the cluster",
}

func (Kubelet) SwaggerDoc() map[string]string {
	return map_Kubelet
}
...
var map_Networking = map[string]string{
...
func (Networking) SwaggerDoc() map[string]string {
	return map_Networking
}
