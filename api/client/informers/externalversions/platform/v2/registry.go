	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV2().Registries().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV2().Registries().Watch(context.TODO(), options)
			},
		},
		&platformv2.Registry{},
		resyncPeriod,
...
func (f *registryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv2.Registry{}, f.defaultInformer)
}

func (f *registryInformer) Lister() v2.RegistryLister {
	return v2.NewRegistryLister(f.Informer().GetIndexer())
}
