...
type ClusterCredentialInformer interface {
	...
	Lister() v2.ClusterCredentialLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV2().ClusterCredentials().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV2().ClusterCredentials().Watch(context.TODO(), options)
			},
		},
		&platformv2.ClusterCredential{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterCredentialInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv2.ClusterCredential{}, f.defaultInformer)
}

func (f *clusterCredentialInformer) Lister() v2.ClusterCredentialLister {
	return v2.NewClusterCredentialLister(f.Informer().GetIndexer())
}
