	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV2().Machines().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV2().Machines().Watch(context.TODO(), options)
			},
		},
		&platformv2.Machine{},
		resyncPeriod,
...
func (f *machineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv2.Machine{}, f.defaultInformer)
}

func (f *machineInformer) Lister() v2.MachineLister {
	return v2.NewMachineLister(f.Informer().GetIndexer())
}
