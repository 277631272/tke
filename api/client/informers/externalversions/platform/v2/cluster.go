	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV2().Clusters().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV2().Clusters().Watch(context.TODO(), options)
			},
		},
		&platformv2.Cluster{},
		resyncPeriod,
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv2.Cluster{}, f.defaultInformer)
}

func (f *clusterInformer) Lister() v2.ClusterLister {
	return v2.NewClusterLister(f.Informer().GetIndexer())
}
