	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV2().CronHPAs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV2().CronHPAs().Watch(context.TODO(), options)
			},
		},
		&platformv2.CronHPA{},
		resyncPeriod,
...
func (f *cronHPAInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv2.CronHPA{}, f.defaultInformer)
}

func (f *cronHPAInformer) Lister() v2.CronHPALister {
	return v2.NewCronHPALister(f.Informer().GetIndexer())
}
