...
type RegistryInterface interface {
	Create(ctx context.Context, registry *v2.Registry, opts v1.CreateOptions) (*v2.Registry, error)
	Update(ctx context.Context, registry *v2.Registry, opts v1.UpdateOptions) (*v2.Registry, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2.Registry, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2.RegistryList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.Registry, err error)
	RegistryExpansion
}
...
func newRegistries(c *PlatformV2Client) *registries {
	return &registries{
		client: c.RESTClient(),
	}
}
...
func (c *registries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.Registry, err error) {
	result = &v2.Registry{}
	err = c.client.Get().
		Resource("registries").
		Name(name).
...
func (c *registries) List(ctx context.Context, opts v1.ListOptions) (result *v2.RegistryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2.RegistryList{}
	err = c.client.Get().
		Resource("registries").
...
func (c *registries) Create(ctx context.Context, registry *v2.Registry, opts v1.CreateOptions) (result *v2.Registry, err error) {
	result = &v2.Registry{}
	err = c.client.Post().
		Resource("registries").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *registries) Update(ctx context.Context, registry *v2.Registry, opts v1.UpdateOptions) (result *v2.Registry, err error) {
	result = &v2.Registry{}
	err = c.client.Put().
		Resource("registries").
		Name(registry.Name).
...
func (c *registries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.Registry, err error) {
	result = &v2.Registry{}
